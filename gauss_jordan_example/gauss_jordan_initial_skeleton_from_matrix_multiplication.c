...
int main(int argc, char** argv)
{
   ...
   // The kernel named "kernel" is enqueued onto the command queue, "command".
   // This can be done multiple times with multiple kernels, e.g. kernel_1, kernel_2, kernel_3
